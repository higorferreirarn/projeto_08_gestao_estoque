...
git commit -m "Initial commit: Sistema de Gestão de Estoque"
```
...
3. **Configure o repositório:**
   - **Repository name**: `projeto_08_gestao_estoque`
   - **Description**: "Sistema de Gestão de Estoque - Projeto do Módulo 1"
...
git remote add origin https://github.com/SEU_USUARIO/projeto_08_gestao_estoque.git
...
```
projeto_08_gestao_estoque/
├── README.md                 # Documentação principal
├── orientacoes.md           # Este arquivo
├── .gitignore               # Arquivos ignorados pelo Git
├── requirements.txt         # Dependências (opcional)
├── sistema_estoque.py      # Código principal
